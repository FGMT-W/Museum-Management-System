<template>
  <div>
    ...
    >  
     <el-row>
      <el-col :span="12">
        <el-form-item   v-if="flag=='gongzuorenyuan'"  label="工作编号" prop="gongzuobianhao">
          <el-input v-model="ruleForm.gongzuobianhao" readonly              placeholder="工作编号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='gongzuorenyuan'"  label="姓名" prop="xingming">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      if((!this.ruleForm.gongzuobianhao)&& 'gongzuorenyuan'==this.flag){
