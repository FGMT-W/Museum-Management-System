  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='gongzuorenyuan'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      if((!this.ruleForm.gongzuobianhao) && `gongzuorenyuan` == this.tableName){
      ...
      if((!this.ruleForm.xingming) && `gongzuorenyuan` == this.tableName){
 ...
 //  }
	...
	.container {
		...
		background-repeat: no-repeat;
    				background-image: url(https://res.cjyun.org/t/site/10695/8c561fd52320442491ddd4ad11bbd1cf/assets/hbsbwg2/list_bg.jpg);
