...
import center from '@/views/center'
    ...
    import zangpinxinxi from '@/views/modules/zangpinxinxi/list'
    ...
    import canguanrenshu from '@/views/modules/canguanrenshu/list'
